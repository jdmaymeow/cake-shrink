<?php
namespace CakeShrink\Test\Fixture;
...
class LinksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'shortened' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'views' => 1,
            'created' => '2016-12-09 11:33:24',
            'modified' => '2016-12-09 11:33:24'
        ],
    ];
}
