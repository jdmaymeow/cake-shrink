<?php
namespace CakeShrink\Controller;

use Cake\Core\Configure;
use CakeShrink\Controller\AppController;

/**
 * Links Controller
 *
 * @property \CakeShrink\Model\Table\LinksTable $Links
 */
class LinksController extends AppController
{
    ...
    public function initialize()
    {
        ...
        $this->loadComponent('CakeShrink.Shrinker');
    }
    ...
    public function view($id = null)
    {
        ...
        $this->set('base_url', Configure::read('CakeShrink.url'));
        $this->set('link', $link);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Links->save($link)) {
                ...
                //Short ID
                $link->shortened = $this->Shrinker->shrink($link->id);
